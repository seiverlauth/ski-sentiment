...
// Scores reflect the word's connotation in skiing context specifically —
// not just general English sentiment. Key corrections vs generic lexicons:
//   - "glade/glades" sounds peaceful but means expert tree skiing → negative
//   - "forest" sounds scenic but = dense tree skiing → slight negative
//   - "ridge" sounds nice but = exposed high terrain → slight negative
//   - Predator animals sound threatening regardless of what runs use them
//   - "bunny hill diction" is deliberately chosen to signal beginner safety
...
export const LEXICON = {
  ...
  // PREDATORS / VENOMOUS — sound threatening regardless of run difficulty
  ...
  // HARSH TERRAIN — geological/physical terms that signal exposure or steepness
  ...
  // ski-domain corrections: these sound neutral/positive but mean expert terrain
  glade: -1, glades: -1, forest: -1, ridge: -1,
  rim: -1, pinnacles: -2, line: -1,
  ...
  diamond: -2, outer: -1, dog: -1, double: -1, land: -1,
  championship: -1, final: -1,

  // BUNNY HILL DICTION — deliberately telegraphs safety to beginners
  ...
  // CONNECTOR / ACCESS TRAILS — low-angle linking runs
